...
### Workshop Structure
- **8-hour core workshop** (9 AM - 5 PM) with optional 1.5-hour extension
- **5 progressive modules** covering environment setup, Java migration, Spring migration, testing, and platform validation
- **Hands-on exercises** with real sample application migration
- **Platform-specific validation** for JBoss EAP, WebSphere, and mainframe environments

### Sample Application
- **Pre-migration baseline**: Java 8 + Spring 5.2.3 + Spring Boot 2.2.4
- **Target state**: Java 21 + Spring 6 + Spring Boot 3.2.0
...
### Primary Users
- **Enterprise development teams** modernizing legacy Java applications
- **Platform engineers** managing application deployments across multiple environments
- **Technical leads** planning and executing large-scale framework migrations
- **DevOps teams** validating applications on target platforms (JBoss EAP, WebSphere, mainframe)

### Use Cases
- **Framework modernization**: Systematic migration from Java 8 + Spring 5 to Java 21 + Spring 6
- **Dependency management**: Updating Maven dependencies and resolving version conflicts
- **Namespace migration**: Converting javax.* imports to jakarta.* for Jakarta EE compliance
- **Security configuration**: Modernizing Spring Security from WebSecurityConfigurerAdapter to SecurityFilterChain
- **Test framework updates**: Migrating from JUnit 4 to JUnit 5 with updated assertions and annotations
